...
private struct AppKeepsakeCardSurfaceModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .familyAmbientDepth(theme: theme, depth: .elevated, yOffset: 10)
    }
}
...
extension View {
    ...
    func appPlaceholderSurface(fill: Color, cornerRadius: CGFloat) -> some View {
        familyRoundedSurface(fill: fill, cornerRadius: cornerRadius)
    }

    func appCircularGlassControl(fill: Color) -> some View {
        familyCircularSurface(fill: fill)
    }
    ...
    func appAmbientDepth(
        ...
        familyAmbientDepth(theme: theme, depth: depth.familyDepth, yOffset: yOffset)
    }
}
