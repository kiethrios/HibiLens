...
/// Stage 1 typography compatibility primitives shared by the Hibi Lens.
///
/// The first role foundation, from `contentHero` through `metricNumber`, expresses
...
/// host/app-owned until a future foundation contract defines it.
public enum HibiLensTypography {
