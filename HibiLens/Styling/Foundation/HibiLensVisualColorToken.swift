...
public struct HibiLensVisualColorToken: Equatable {
    ...
    public func contrastRatio(with other: HibiLensVisualColorToken) -> Double {
...
public struct HibiLensAdaptiveColorToken: Equatable {
    public let day: HibiLensVisualColorToken
    public let dark: HibiLensVisualColorToken

    public init(day: HibiLensVisualColorToken, dark: HibiLensVisualColorToken) {
        self.day = day
        self.dark = dark
    }
    ...
    public func value(for interfaceStyle: UIUserInterfaceStyle) -> HibiLensVisualColorToken {
