...
public enum DefaultFamilyPalette {
    ...
    public static let cameraFocus = FamilyVisualColorToken(red: 255, green: 248, blue: 232)
    ...
    ) -> FamilyAdaptiveColorToken {
        FamilyAdaptiveColorToken(
            day: FamilyVisualColorToken(red: day.0, green: day.1, blue: day.2),
            dark: FamilyVisualColorToken(red: dark.0, green: dark.1, blue: dark.2)
        )
    }
}
